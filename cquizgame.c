/*	A project made by Praneeth and Akanksha
	Mini project for the course: programming for problem solving
	Authors: @NotPraneeth and @as9130 */
...
void reset_score();
void help();
void edit_score(float , char []); //functions with parameters
...
int main()
     ...
     char choice;
     char playername[20];
     mainhome:  //Asking for input to start the game or any other option
     system("cls");
     printf("\t\t\tA VERY FUN AND EXCITING QUIZ GAME\n");
     ...
     printf("\n\t\t________________________________________");
     printf("\n\t\t________________________________________");
     printf("\n\t\t   WHO WILL SCORE THE MORE POINTS? WILL IT BE YOU? LETS FIND OUT!    ") ;
     printf("\n\t\t________________________________________");
     printf("\n\t\t________________________________________");
     ...
     printf("\n\t\t > press Q to quit             ");
     printf("\n\t\t________________________________________\n\n");
     choice=toupper(getch());  //function to do actions based on user input
     if (choice=='V')  
	{
	show_record();
	goto mainhome;
    ...
    printf("\n\n\n\n\n\n\n\n\n\n\t\t\tWhat should we call you?"); //This input is assigned to playername.
     gets(playername);

    system("cls"); //Tips and instructions on how to play the game
    printf("\n ------------------  Welcome to the Quiz %s! --------------------------",playername);
    ...
    system("cls");
     ...
     switch(r1) //Displaying Warmup questions
		{
		case 1:
	...
	{
	system("cls");
	printf("\n\nYOU FAILED THE WARMUP TEST, BETTER LUCK NEXT TIME");
	getch();
	goto mainhome;
	}
     test:
...
game:
     ...
     switch(r) //Dsiplaying game questions
		{
		case 1:
	...
	score:
    system("cls");
	score=(float)countr*100000; //calculating score
	if(score>0.00 && score<1000000) //printing messages based on user score
	{
	   printf("\n\n\t\t**************** CONGRATULATIONS *****************");
...
void show_record() //function definitons
    {system("cls");
	char name[20];
	float scr;
	FILE *f; 
	f=fopen("score.txt","r"); //file operations
	fscanf(f,"%s%f",&name,&scr);
	printf("\n\n\t\t*************************************************************");
	printf("\n\n\t\t %s has secured the Highest Score, SCORE: %0.2f",name,scr);
	printf("\n\n\t\t*************************************************************");
	fclose(f);
	getch();}

void reset_score() //function definition to reset score
    {system("cls");
    float sc;
	char nm[20];
	FILE *f;
...
void help() //function definition to print help message
	{system("cls");
    printf("\n\n                              HELP");
    printf("\n -------------------------------------------------------------------------");
    printf("\n ......................... C program Quiz Game...........");
	...
	printf("\n\n\t*********************BEST OF LUCK*********************************");
	printf("\n\n\t*****THIS QUIZ GAME is developed by agnasha and praneeth********");}

void edit_score(float score, char plnm[20]) //function to edit score
	{system("cls");
	float sc;
	char nm[20];
	FILE *f;
